...
try
{
  ...
  String q1="create table users(name varchar(100), email varchar(100) primary key, mobileNumber varchar(50), securityQuestions varchar(200), answer varchar(200), password varchar(100), address varchar(500), city varchar(100), state varchar(100), country varchar(100),wallet int)";
  ...
  String q5="create table managers(id,name varchar(500),email varchar(100) primary key,password varchar(100))";
