...
try
{
	...
	int balance=0;
	PreparedStatement ps1=con.prepareStatement("select wallet from users where email=?");
	...
	PreparedStatement ps2=con.prepareStatement("Update users set wallet=? where email=?");
...
<button class="button" type="submit"> Proceed to generate bill & save</button><i class='far fa-arrow-alt-circle-right'></i>
