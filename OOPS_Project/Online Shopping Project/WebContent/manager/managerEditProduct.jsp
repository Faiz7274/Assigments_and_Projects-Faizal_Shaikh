...
<body>
 <h2><a class="back" href="managerAllProductEditProduct.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></h2>
<%
...
%>
<form action="managerEditProductAction.jsp" method="post">
